 ...
 *                        From v2.7.2
 *                        A sign is added to the radial velocity output from the obstacle detector
 *                        when the "allow reverse" mode is selected
 *                        @ref acc_detector_obstacle_configuration_set_allow_reverse
 *                        The function @ref acc_detector_obstacle_processing_radial_velocity_to_degrees
 *                        retains the previous behavior when processing the signed radial velocity,
 *                        because it is revised to take the absolute value of the radial velocity
 ...
 * The absolute value of the radial velocity is used in the angle calculation
 * to accommodate a negative radial velocity (as seen for a sensor that is
 * facing the reverse direction of the robot motion).
 *
